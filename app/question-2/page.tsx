          ...
          <div className="space-y-6">
            ...
            <section className="space-y-6 leading-relaxed text-gray-200">
              ...
              <p className="text-gray-300">
                Sure i can give you a quick insight into what "Fluid Compute"
                is, and why it would be great for you!
              </p>

              <div className="my-6 p-5 border-l-4 border-purple-500 bg-gray-900/50 rounded-r-lg">
                <p className="text-lg text-gray-200">
                  Fluid Compute just means you can mix Edge, Serverless, Static,
                  and Client-side rendering in a single Next.js app. No need to
                  wire things together manually. You focus on building features
                  and Vercel handles where and how each part runs behind the
                  scenes.
                </p>
              </div>
              ...
              <ul className="space-y-3 pl-1">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong className="text-white">
                      Serverless is still part of it
                    </strong>{" "}
                    <span className="text-gray-300">
                      — but now it's one of several compute options, not the
                      only one.
                    </span>
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    <span className="text-gray-300">
                      — you don't need to set up API gateways, regions, or edge
                      handlers yourself.
                    </span>
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    <span className="text-gray-300">
                      — Next.js handles behavior; Vercel deploys it smartly.
                    </span>
                  </span>
                </li>
              </ul>
              ...
              <ol className="space-y-4 pl-1">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">
                    You can kick off a fast response using an Edge Function,
                    handle the heavy GenAI processing in a Serverless Function,
                    and stream or render the result however you want with SSR,
                    CSR, all in one app.
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">
                    No juggling cloud providers or spinning up extra infra. The
                    deploy flow stays the same.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="flex-shrink-0 h-6 w-6 rounded-full bg-purple-500/30 flex items-center justify-center mr-3 mt-0.5 text-purple-300 text-sm font-medium">
                  ...
                  <span className="text-gray-300">
                    It scales with you as edge functions run globally,
                    serverless scales up as needed, and static content is
                    CDN-cached by default.
                  </span>
                </li>
              </ol>
